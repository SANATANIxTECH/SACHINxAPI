...
from SACHINxAPI.func import (MORSE_CODE_DICT,payloads_response,gpt_4_mode,payload8)
from base64 import b64decode as m,b64encode as n
from SACHINxAPI.words import wordshub
from PIL import Image, ImageDraw, ImageFont
from SACHINxAPI.truth_dare import TRUTH,DARE
__version__ = "0.6.5.6"
...
class SACHINxAPI:
    ...
    def datagpt(args:str):
        ...
        try:
            ...
            return {"results":data["text"],"join": "@ALL_SANATANI_BOT", "success": True
                    }
    ...
    def blackbox(args: str) -> requests.Response:
        ...
        try:
            ...
            if response.status_code == 200:
                return {"results": response.text, "join": "@ALL_SANATANI_BOT", "success": True}
        except Exception as e:
            return e  
    ...
    def chatgpt(args:str,mode:str=False):
        ...
        if not mode:
            ...
            return {"results":response.json()["response"],"join": "@ALL_SANATANI_BOT", "success": True}
        else:
            try:
                result = gpt_4_mode(args, mode)
                return {"results":result,"join": "@ALL_SANATANI_BOT", "success": True}
    ...
    def randomword():
        ...
        return {"results": word, "join": "@ALL_SANATANI_BOT", "sucess": True}
    ...
    def gemini(args: str) -> dict:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {"results":generated_text,"join": "@ALL_SANATANI_BOT", "success": True}
        except Exception as e:
            return e
    ...
    """
        ...
        if response.status_code == 200:
            ...
            return {"results": image_urls, "join": "@ALL_SANATANI_BOT", "success": True}
        else:
    ...
    Example usage:
    >>> from SACHINxAPI import api
    >>> search_results = api.repo("HIMANSHI_MUSIC_BOT")
    ...
    """
        ...
        return {"results": result, "join": "@ALL_SANATANI_BOT", "sucess": True}
